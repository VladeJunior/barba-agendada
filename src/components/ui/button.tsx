  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-gold text-primary-foreground font-semibold shadow-lg hover:shadow-gold hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-gradient-gold text-primary-foreground font-semibold text-base shadow-lg hover:shadow-gold hover:scale-[1.02] active:scale-[0.98] px-8 py-6",
        "outline-gold": "border-2 border-gold text-gold hover:bg-gold hover:text-primary-foreground transition-colors",
      },
      size: {
