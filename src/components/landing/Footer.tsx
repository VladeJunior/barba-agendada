        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://api.whatsapp.com/send?phone=5519998733540" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center hover:bg-gold/20 transition-colors">
