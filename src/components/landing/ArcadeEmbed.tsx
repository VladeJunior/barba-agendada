...
export function ArcadeEmbed() {
  ...
  return (
    <div
      style={{
        position: "relative",
        paddingBottom: "calc(51.49094781682641% + 41px)",
        height: "0",
        width: "100%",
      }}
    >
      <iframe
        ref={arcadeIframeRef}
        src="https://demo.arcade.software/spk9P1y4KglNIem1KFZH?embed&embed_mobile=modal&embed_desktop=modal&show_copy_link=true"
